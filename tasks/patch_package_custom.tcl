...
namespace eval ::patch_package_custom {
    ...
    array set ::patch_package_custom::options {
		...
		--pkg-label4 "                                                                                                                                                    : :"
		--REPLACE1 ""
		--REPLACE2 "host_provider_"
		--REPLACE3 "/dev_hdd0/PKGS"
		--pkg-label5 "--------------------------------------------------------------------------------------------------------------   : :"
    }
    ...
    proc main {} {
		...
		::modify_devflash_file $CATEGORY_GAME_TOOL2_XML ::patch_package_custom::callback_patch
		::modify_devflash_file $CATEGORY_GAME_XML ::patch_package_custom::callback_patch
